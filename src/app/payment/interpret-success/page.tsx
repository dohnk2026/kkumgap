  ...
  if (status === "loading") {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center" style={bgMain}>
        ...
        <p className="text-white font-medium mb-1">몽해 할머니가 꿈을 풀어보는 중...</p>
  ...
  if (status === "error") {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center px-5" style={bgMain}>
        ...
        <h1 className="text-xl font-bold text-white mb-2">해석에 실패했어요</h1>
    ...
    <main className="min-h-screen relative" style={bgMain}>
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-5 py-10 pb-24">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white mb-1">유료 해석 완료!</h1>
          <p className="text-sm" style={{ color: "#a78bfa" }}>몽해 할머니의 심층 해몽을 확인하세요</p>
        </div>
