  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-5"
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse at 50% 30%, rgba(76, 29, 149, 0.15) 0%, transparent 60%)" }} />
      ...
      <div className="relative z-10 text-center max-w-sm w-full">
        ...
        {code && (
          <p className="text-xs mb-8" style={{ color: "rgba(167, 139, 250, 0.4)" }}>Error code: {code}</p>
        )}
        <div className="space-y-3">
          <Link href="/market" className="block w-full py-3.5 rounded-xl text-white font-semibold text-center"
            style={{ background: "linear-gradient(135deg, #7c3aed, #4f46e5)" }}>
            Back to Dream Market
          </Link>
          <Link href="/" className="block w-full py-3 rounded-xl font-medium text-center"
