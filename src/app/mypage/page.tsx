...
export default function MyPage() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      const [dreamsRes, purchasesRes, salesRes] = await Promise.all([
        supabase
          .from("dreams")
          .select("*")
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-5 pb-20">
        ...
        >
          {([
            { key: "selling" as Tab, label: `내 꿈 (${myDreams.length})` },
            { key: "bought"  as Tab, label: `구매한 꿈 (${purchases.length})` },
                    ...
                    >
                      ...
                      >
                        <div className="flex items-start justify-between gap-3 mb-2">
                          <h3
                            className="font-semibold text-sm leading-snug line-clamp-1 flex-1"
                            style={{ color: "#f1f5f9" }}
                          >
                            {dream.title}
                          </h3>
